...
Vector createLocalb(int e,mesh &m){
    ...
    float f_x = m.getParameter(PSIX_PARAM);
    float f_y = m.getParameter(PSIY_PARAM);
    float eta = m.getParameter(ETA_PARAM);
